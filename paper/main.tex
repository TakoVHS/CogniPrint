...
The broader mathematical background of the manuscript is compatible with information-theoretic thinking and quantitative style analysis, while remaining narrower in scope than those literatures; see, for example, Shannon's foundational treatment of information, Holmes's historical account of stylometry, and the computational text-analysis perspective of Eder, Rybicki, and Kestemont.
...
\bibitem{Holmes1998}
David I. Holmes.
\newblock The Evolution of Stylometry in Humanities Scholarship.
\newblock \emph{Literary and Linguistic Computing}, 13(3):111--117, 1998.
\newblock doi:10.1093/llc/13.3.111.

\bibitem{EderEtAl2016}
Maciej Eder, Jan Rybicki, and Mike Kestemont.
\newblock Stylometry with R: A Package for Computational Text Analysis.
\newblock \emph{The R Journal}, 8(1):107--121, 2016.
\newblock doi:10.32614/RJ-2016-007.
