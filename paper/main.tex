...
A formal reference list has not yet been added. The next literature pass should introduce only real and directly relevant sources. No placeholder citations are intentionally included in the current manuscript.
