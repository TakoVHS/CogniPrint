...
## source-id: empirical-campaign-003-self-authored-baseline

- source_name: Self-authored CogniPrint campaign-003 baseline
- source_ref: workspace/input/campaign-003/original.txt
- source_class: self-authored
- license: self-authored local research use
- acquisition_date: 2026-04-23
- usage_note: Longer local baseline for controlled perturbation study on empirical profile stability.
- storage_scope: local-only unless explicitly prepared for public release

## source-id: empirical-campaign-003-light-edit

- source_name: Self-authored CogniPrint campaign-003 light edit
- source_ref: workspace/input/campaign-003/edited.txt
- source_class: self-authored
- license: self-authored local research use
- acquisition_date: 2026-04-23
- usage_note: Light edit derived from the campaign-003 baseline for measured profile-shift comparison.
- storage_scope: local-only unless explicitly prepared for public release

## source-id: empirical-campaign-003-controlled-variants

- source_name: Self-authored CogniPrint campaign-003 controlled variants
- source_ref: workspace/input/campaign-003/variants/
- source_class: self-authored
- license: self-authored local research use
- acquisition_date: 2026-04-23
- usage_note: Ten controlled variants derived from the campaign-003 baseline. Each variant is intended to vary one main perturbation axis where possible.
- storage_scope: local-only unless explicitly prepared for public release

## campaign-003 variant-map

- 01_punctuation_cleanup.txt: punctuation and sentence-boundary surface change
- 02_minor_lexical_substitution.txt: mild lexical substitution
- 03_sentence_split_merge.txt: sentence segmentation change
- 04_word_order_shift.txt: word-order and syntax shift
- 05_compressed_version.txt: controlled compression
...
- 07_formalized_style.txt: style formalization
- 08_informalized_style.txt: style relaxation
- 09_strong_rewrite_same_claim.txt: stronger paraphrase preserving the central research claim
- 10_translated_or_crosslingual.txt: cross-lingual variant preserving the research topic
